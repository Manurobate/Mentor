...
export class AddAnnounces1774968616957 implements MigrationInterface {
    name = 'AddAnnounces1774968616957'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`subject_entity\` DROP FOREIGN KEY \`FK_1380fa88fa7bb134c30d8c083b9\``);
        await queryRunner.query(`CREATE TABLE \`announce_entity\` (\`id\` int NOT NULL AUTO_INCREMENT, \`price\` int NOT NULL, \`subjectId\` int NULL, \`levelId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`announce_entity\` DROP FOREIGN KEY \`FK_225f58c89ce5156ea2d30e0e4a8\``);
        await queryRunner.query(`ALTER TABLE \`announce_entity\` DROP FOREIGN KEY \`FK_2118f2c1988da41bcf77c75f3b2\``);
        await queryRunner.query(`ALTER TABLE \`subject_entity\` ADD \`levelId\` int NULL`);
